...
export default function ProfileScreen() {
  ...
  if (user) {
    ...
    return (
      ...
      >
        <View
          style={[styles.avatarCircle, { backgroundColor: colors.primary + "20", borderColor: colors.primary + "40" }]}
        >
        ...
        <View style={styles.actions}>
          ...
          >
            ...
            <Text style={[styles.actionText, { color: colors.foreground }]}>About AIPrintVerse</Text>
    ...
    >
      ...
      >
        <View style={styles.authHeader}>
          <View style={[styles.logoCircle2, { backgroundColor: colors.primary + "18" }]}>
        ...
        <View style={styles.form}>
          <View>
            ...
            <TextInput
              ...
              autoComplete="email"
              style={[styles.input, { backgroundColor: colors.muted, color: colors.foreground, borderColor: colors.border, borderRadius: colors.radius }]}
            />
          </View>
          <View>
          ...
          <Pressable
            ...
            style={({ pressed }) => [
              styles.submitBtn,
              { backgroundColor: colors.primary, borderRadius: colors.radius, opacity: pressed || submitting ? 0.8 : 1 },
            ]}
          >
            {submitting ? (
          ...
          >
            <Text style={[styles.aboutLinkText, { color: colors.mutedForeground }]}>
              About AIPrintVerse
            </Text>
          </Pressable>
        </View>
...
const styles = StyleSheet.create({
  ...
  card: { width: "100%", borderWidth: 1, overflow: "hidden", marginTop: 8 },
  ...
  logoCircle2: { width: 72, height: 72, borderRadius: 36, alignItems: "center", justifyContent: "center", marginBottom: 8 },
  ...
  submitBtn: { height: 50, alignItems: "center", justifyContent: "center", marginTop: 4 },
  ...
  aboutLinkText: { fontSize: 13, fontFamily: "Inter_400Regular" },
});
