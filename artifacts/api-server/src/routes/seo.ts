...
router.post("/seo/auto-link-keywords", requireAdmin, async (req, res) => {
  const data = { ...req.body };
...
router.post("/seo/article-templates", requireAdmin, async (req, res) => {
...
router.post("/seo/generation-batches", requireAdmin, async (req, res) => {
